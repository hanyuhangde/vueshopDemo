...
<template>
  <header class="header">
    ...
    <div class="navbar" style="display: flex;justify-content: space-between;">
      ...
      <div class="navbar-right-container" style="display: flex; justify-content: center;
  align-items: center;">
        <div class="navbar-menu-container" style="display: flex;">
          <!--<a href="/" class="navbar-link">我的账户</a>-->
          <span class="navbar-link" v-text="nickName" v-if="nickName" style="padding-right: 8px;"></span>
          <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!nickName" style="padding-right: 8px;">Login</a>
          <a href="javascript:void(0)" class="navbar-link" @click="logOut" v-if="nickName" style="padding-right: 8px;">Logout</a>
          <div class="navbar-cart-container">
            <span class="navbar-cart-count" style="position: absolute;background: red;border-radius: 50%;color: #fff;
    right: 17px;width: 20px;height: 20px;top: 14px;text-align: center;" v-if="cartCount>0">{{cartCount}}</span>
            <a class="navbar-link navbar-cart-link" href="/#/cart">
              <img src="./../assets/shopping.png" class="navbar-cart-logo"/>
            </a>
          </div>
        </div>
      </div>
